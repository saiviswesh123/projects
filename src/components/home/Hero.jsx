      ...
      <div className="grid place-items-center">
        ...
        <div className="hero-section-card">
          <div className="bg-black text-white w-full flex">
            <button
              className={ activeSection === "flights" === true ? "flex p-3 hotel-title flight-title" : "flex p-3 hotel-title" }
            ...
            <button 
              className={ activeSection === "hotels" === true ? "flex p-3 hotel-title flight-title" : "flex p-3 hotel-title" }
            ...
            <button
              className={ activeSection === "carRentals" === true ? "flex p-3 hotel-title flight-title" : "flex p-3 hotel-title" }
